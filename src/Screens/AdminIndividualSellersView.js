...
class AdminIndividualSellersView extends Component {
    ...
    render() {
        ...
        return (
            ...
            <div className="parent">
                <h4 className="mb-2">Individual Sellers</h4>
                <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>2/1/2021</td>
                        <td><a href="approval_files" className="btn btn-success">check approval files</a></td>
                    </tr>
                    <tr>
                        <th scope="row">sunfoundary corp.</th>
                        <td>individual seller</td>
...
export default AdminIndividualSellersView;
