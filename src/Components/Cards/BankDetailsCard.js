        ...
        return (
                  ...
                  <form className="">
                      ...
                      <div className="clearfix mb-3">
                          <h4 className="float-left">{t(`home.BankDetailsCard.bank_detail`)}</h4>
                      ...
                      <div className="form-row">
                          <div className="col-sm-6">
                              <label for="card-date">{t(`home.BankDetailsCard.expire_date`)}</label>
                      ...
                      <div className="mt-4">
                          <button className="btn btn-lg btn-success">{t(`home.BankDetailsCard.withdraw`)}</button>
                      </div>
                  </form>
              </div>
            );
...
export default withTranslation() (BankDetailsCard);
